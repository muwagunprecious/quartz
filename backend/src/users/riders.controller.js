...
var RidersController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('riders'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.Controller)('riders')];
    ...
    var RidersController = _classThis = /** @class */ (function () {
        function RidersController_1(prisma) {
            this.prisma = (__runInitializers(this, _instanceExtraInitializers), prisma);
        }
        RidersController_1.prototype.getProfile = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                var profile;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.riderProfile.findUnique({
        ...
        RidersController_1.prototype.updateStatus = function (req, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        RidersController_1.prototype.verifyRider = function (id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.riderProfile.update({
                            where: { id: id },
        ...
        return RidersController_1;
    }());
    __setFunctionName(_classThis, "RidersController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _getProfile_decorators = [(0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')), (0, common_1.Get)('me'), (0, swagger_1.ApiOperation)({ summary: 'Get current rider profile' })];
        _updateStatus_decorators = [(0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')), (0, common_1.Patch)('status'), (0, swagger_1.ApiOperation)({ summary: 'Toggle Rider Online/Offline Status' })];
        _verifyRider_decorators = [(0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)(client_1.Role.ADMIN), (0, common_1.Patch)(':id/verify'), (0, swagger_1.ApiOperation)({ summary: 'Verify or Reject a Rider (Admin only)' })];
        ...
        RidersController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RidersController = _classThis;
}();
