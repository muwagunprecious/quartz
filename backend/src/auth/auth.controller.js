...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.refresh = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.refreshToken(dto.refresh_token)];
                });
            });
        };
    ...
    (function () {
        ...
        _register_decorators = [(0, common_1.Post)('register'), (0, swagger_1.ApiOperation)({ summary: 'Register a new user (Student, Seller, Rider)' })];
        _login_decorators = [(0, common_1.Post)('login'), (0, swagger_1.ApiOperation)({ summary: 'Login user' })];
        _refresh_decorators = [(0, common_1.Post)('refresh'), (0, swagger_1.ApiOperation)({ summary: 'Refresh access token' })];
        _getProfile_decorators = [(0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')), (0, common_1.Get)('me'), (0, swagger_1.ApiOperation)({ summary: 'Get current user profile' })];
